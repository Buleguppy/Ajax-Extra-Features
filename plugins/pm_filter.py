...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝙲𝚁𝙴𝙰𝚃𝙾𝚁𝚂', callback_data='deploy')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('♥️ 𝚂𝙾𝚄𝚁𝙲𝙴 𝙲𝙾𝙳𝙴 ♥️', url='https://t.me/planet_movies_nami_updates')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("Please Check the Spelling of the movie from the below Table 👇🏻👇🏻👇🏻",
                    reply_markup=InlineKeyboardMarkup(btn))
